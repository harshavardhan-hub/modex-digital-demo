...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-primary via-primary to-neutral-900 text-white overflow-hidden pt-6 md:pt-0">
      {/* Background Pattern */}
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-lg sm:text-xl text-neutral-300 mb-8 max-w-2xl mx-auto lg:mx-0"
            >
            ...
            >
              <Button as={Link} to="/contact" variant="primary" size="lg" className="group">
            ...
            >
              <div>
                ...
                <div className="text-sm text-neutral-400 mt-1">Clients</div>
              </div>
              <div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-24 h-24 bg-accent rounded-full opacity-20 blur-2xl"
              ></motion.div>
              <motion.div
                animate={{ y: [10, -10, 10] }}
                transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
                className="absolute -bottom-4 -left-4 w-32 h-32 bg-accent2 rounded-full opacity-20 blur-2xl"
              ></motion.div>
            </div>
          </motion.div>
        </div>
